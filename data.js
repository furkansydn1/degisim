...
const VENT_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      { q: 'Eşinin ya da sevgilinin senin için doğru kişi olduğunu düşünüyor musun? Eğer cevabın net bir evet değilse, seni hâlâ orada tutan ne? Vazgeçemediğin nokta nedir — onun sana verdiği bir şey mi, senin kendi içinde tamamlanmamış bir parça mı? Eğer onunla bugün ilk kez tanışsaydın, onu yine seçer miydin?', hint: '"Doğru kişi" demek mükemmel kişi değil. Ama seni gerçekten gören, büyüten, kendin olmana izin veren biri mi? Eğer "evet ama..." diye başlıyorsan o "ama"ya dikkatle bak — asıl cevap orada saklı.' },
      { q: 'Şimdi bir an gözlerini kapat ve onun yerine geç. Onun gözünden, sana karşı kendine nasıl davranırdın? Hangi anlarda kendini sıkıcı, hangi anlarda kendini sevimli bulurdun? Onun sustuğu yerlerde sen ne hissedersin, sen sustuğunda o ne hissediyor olabilir? Bunu detaylıca, sanki gerçekten oymuşsun gibi, kendine partneriymişsin gibi yaz.', hint: 'Bu egzersiz zor ama dönüştürücüdür. Onun bakışından kendine bak — belki hiç görmediğin bir yanını fark edersin. Belki ona haksızlık ettiğin yerleri, belki senin ne kadar yorucu olabildiğini. Ya da tam tersi — onun sana ne kadar haksızlık ettiğini.' },
      ...
      { q: 'Şimdi sihirli bir güce sahip olduğunu hayal et. Eşini/sevgilini karşına aldın ve ona içindeki her şeyi söyleyeceksin — o asla seni yargılamayacak, kızmayacak, ayrılmayacak, küsmeyecek, darılmayacak. İstediğin her şeyi söylemekte özgürsün; en ağır cümleleri, asla söylenmeyecek şeyleri, içinden ne geçiyorsa — bir küfür bile olabilir. Ona neler söylerdin? Dök bakalım içini.', hint: 'Bu hayali bir güvenlik alanı. Gerçekten orada değil o kişi, kimse okumuyor — sadece kelimeler döküldüğünde neyin çıktığını görmek için bir deney. Yıllardır yuttuğun cümleler bazen bu hayali konuşmada kendi kendine çıkar. Süzme, nazikleştirme, "böyle demeyeyim" deme. Ham hali.' },
