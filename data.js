...
const VENT_CATEGORIES = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'Kafandaki sevgili/eş ile gerçeği arasındaki farklar neler? Her yönüyle, detaylı bir şekilde açıklar mısın?', hint: 'Herkesin kafasında bir ideal vardır ve herkesin yanındaki insan o idealle aynen örtüşmez. Fiziksel özelliklerinden ruhuna, konuşma tarzından hayallerine kadar bak. Senin ideal listenle gerçek arasındaki boşluk ne kadar büyük? Göz rengi kadar küçük bir şey mi, yoksa ruh şekli kadar temel bir şey mi?' },
      { q: 'İlişkiniz tek taraflı mı — sadece onun hayalleri, onun istekleri ve onun hayatı mı konuşuluyor? Yoksa gerçek bir ilişkide olması gerektiği gibi iki kişilik bir hayat mı yaşıyorsunuz?', hint: 'Son bir haftayı düşün. Senin bir hayalin, bir korkun, bir planın konuşuldu mu — yoksa hep onun işi, onun ailesi, onun sıkıntıları mı sahnedeydi? "Destekleyici olmak" güzel ama ikinci planda olmaya alışmak başka bir şey.' },
      { q: 'Aranızda geçen ve içinden "işte tam o an benden koptu/uzaklaştı" dediğin, ama onun belki de hiç fark etmediği o sessiz kırılma anı neydi?', hint: 'Kavga değil, gürültü değil. Belki bir bakış, bir cümle, bir ihmal. Sen biliyorsun hangi an olduğunu — "o andan sonra bir şey hiç eski gibi olmadı" dediğin an. Bunu yıllardır içinde taşıyor olabilirsin.' },
      { q: 'Ona bakarken "iyi ki var" dediğin anlar olmuştur elbette. Ama hiç, "keşke onu hiç tanımasaydım" dedirtecek kadar seni tükettiği, çaresiz bıraktığı o karanlık an oldu mu?', hint: 'Bunu itiraf etmek kolay değil, çünkü sevdiğin birine karşı böyle düşündüğün için kendini suçluyorsun. Burada suçlu yok — sadece insan var. O an ne oldu, sen nasıl hissettin?' },
      { q: 'Hadi bana dürüst ol: hiç içinden "keşke o değil de ......... olsaydı hayatımda, o benim istek ve arzularıma daha yakın" dediğin biri oldu mu hayatında?', hint: 'Aldattın mı aldatmadın mı meselesi değil bu. Bir düşüncenin senin kafanda kurulmuş olması yeterli. O başka kişi aslında karşındakinde bulamadığın neyi temsil ediyordu?' },
      { q: 'Hiç içinden "bu ilişki zaten olmayacak, geleceğimiz yok, ama ben yine de devam edeyim" dediğin oldu mu? Cevabın evetse — olmayacağını bildiğin halde devam etmene sebep olan şey ne?', hint: 'Yalnız kalmak korkusu mu? Onu üzmek istemiyor musun? Başkasını bulamayacağını mı düşünüyorsun? Yoksa "bir süre daha dayanırsam düzelir" diye mi diyorsun? İçinde kaç senedir bu cümle dönüyor?' },
      { q: 'Geleceğe dair seni en çok korkutan şey ne? İlişki adına hangi senaryoyu yaşamaktan korkuyorsun?', hint: '"Bitmesin" en yüzeysel korkudur çoğu zaman. Daha derin bak — "ayrılırsak yalnız kalırım" mı? "Kalırsak ben tükenirim" mi? "Evleniriz ama mutlu olmayız" mı? Korkun sana asıl gerçeği söylüyor.' },
      { q: '"Hiç mutlu değilim ama onu seviyorum" diye kendini kandırdığın zamanlar oluyor mu? Bilakis, sevdiğin insanla mutlu olursun — mutlu değilsen ve "seviyorum" diyerek kendini kandırıyorsan, sence bunun altında yatan anlam ne? Neden ilişkiyi bitirecek cesareti bulamıyorsun kendinde — alışkanlık mı, korku mu?', hint: 'Bu soru sert, biliyorum. Ama "seviyorum" kelimesi bazen bir kelepçeye dönüşür — sorgulamayı bıraktığın an rahatlarsın çünkü. Cümleyi bitirmeye çalış: "Aslında onu ........... için devam ediyorum." Bu boşluğa ne yazarsın?' }
    ]
  },
  {
    key: 'is',
